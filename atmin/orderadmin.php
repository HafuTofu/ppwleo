          ...
          <div class="w-1/4 flex flex-col items-center">
            <div class="flex items-center space-x-2">
              ...
              <select class="p-2 border rounded-md text-sm w-40 text-center" name="status" disabled>
                ...
                <option value="Delivering" <?php echo $rowst['order_status'] == 'Delivering' ? 'selected' : ''; ?>>Delivering
                </option>
                ...
                <option value="Canceled" <?php echo $rowst['order_status'] == 'Canceled' ? 'selected' : ''; ?>>Canceled</option>
              </select>
            </div>
